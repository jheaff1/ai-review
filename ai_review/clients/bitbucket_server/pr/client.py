...
class BitbucketServerPullRequestsHTTPClient(HTTPClient, BitbucketServerPullRequestsHTTPClientProtocol):
    ...
    async def delete_comment_api(
        ...
        return await self.delete(f"/projects/{project_key}/repos/{repo_slug}/pull-requests/{pull_request_id}/comments/{comment_id}")
    ...
    async def delete_comment(
        ...
        await self.delete_comment_api(project_key, repo_slug, pull_request_id, comment_id)
